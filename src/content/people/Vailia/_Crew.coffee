Person.VailianCrewM = class VailianCrewM extends Person.RandomPerson
  @descriptions: [
    ->"""#{@} doesn't talk about #{his @} past much, preferring to look toward the future."""
    ->"""#{@} will talk at great length to anyone who will listen about #{his @} childhood. This would be more interesting if #{he} weren't so completely average."""
    ->"""#{@}'s mouth snaps shut the instant anyone tries to ask about where #{he @}'s from or why #{he}'s chosen the life of a sailor. Kat doesn't pry."""
    ->"""#{@} is open, holding no secrets back. #{He @}'ll answer any questions Kat asks about #{his} past."""
  ]
  name: 'VailianCrewM'
  gender: 'm'
  happiness: 30
  ...
  text: '#999999'
  @images:
    path: 'src/content/people/Vailia/'
    normal: [
      'MNormalSkin.png'
      'MNormalHair.png'
      'MNormalEyes.png'
