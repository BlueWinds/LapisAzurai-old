...
Page.KatClothes.next.Angry = Page.KatClothesAngry = class KatClothesAngry extends Page
  ...
  || bg="Ship.cabinDay'
    #{Kat.image 'normalNude', 'right'}

  ||
    #{Kat.image 'uncertainNude', 'right'}

  ||
    #{Kat.image 'sadNude', 'right'}
...
Page.KatClothes.next.Laughing = Page.KatClothesLaughing = class KatClothesLaughing extends Page
  ...
  || speed="slow"
    #{@Kat.image 'embarrassed', 'right'}
    --> Slowly, the thief complied.

  ||
    #{@Kat.image 'embarrassedNude', 'right'}
