...
ShipJob.Spirit.next.push Page.SpiritFish = class SpiritFish extends Page
  ...
  ||
    --> <q>Why?</q> The creature almost sounded like it was whinning.
  ...
  ||
    --> #{q}I'm very, very sorry. May we please depart? We promise to do no more harm here.</q> At her gesture the rest of the crew quietly cut away the net they'd had raised halfway our of the water when the monster appeared, dropping its still squirming contents back into the ocean.
