Place.IronSands = Game::map.IronSands = class IronSands extends Place
  ...
  <em><span class='energy'>-1 energy</span>, <span class='damage'>+1 ship damage every day</span></em>"""
  images:
    ...
    marketNight: 'game/content/locations/VailiaEnvirons/Town Desert Night.jpg'
