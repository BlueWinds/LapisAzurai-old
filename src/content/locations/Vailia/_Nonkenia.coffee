...
Place.Nonkenia::firstVisit = Page.VisitNonkenia = class VisitNonkenia
  conditions:
    Nat: '|officers|Nat'
  text: ->"""|| bg="night"
  ...
  ||
    -- <q>There you go, girl. The forest isn't dangerous anymore. For you. As long as you take the left trail, then left fork, then right. Got that? Left, left, right.</q> Another dry chuckle, a sound Natalie was beginning to thoroughly loathe. <q>Anyone else who feels like walking to the city, come and take your turn. You can wipe it off once you're inside the city, but make sure you get annointed again before you try to return to the ship. It'd be a shame if some of you didn't make it back.</q>
"""
...
Job.NonkeniaRest.next.push Page.NonkeniaRest = class NonkeniaRest extends Page
  ...
  ||
    -- She shook her head slowly, looked back down at her fire. <q>You're not the one I'm waiting for, but you are welcome to join me if you wish.</q>
