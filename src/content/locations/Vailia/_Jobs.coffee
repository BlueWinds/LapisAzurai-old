...
Page.LibraryTravel.next.push Page.LibraryTravelAlkenia = class LibraryTravelAlkenia extends Page
  ...
  text: ->"""<page bg="marketDay|marketStorm">
    <text>
      ...
      Passing through Mt. Julia, one can sail to <strong>Alkenia</strong>, a relatively major and independent city. The closest real settlement to Vailia, it's nominally independent but firmly under Vailia's influence and welcoming of merchants. They'll buy textiles and other Vailian manufactured goods at an excellent price.
    </text>
  </page>"""
  apply: ->
    super()
...
Page.LibraryTravel.next.push Page.LibraryTravelDirect = class LibraryTravelDirect extends Page
  ...
  text: ->"""<page bg="marketDay|marketStorm">
    <text>
      ...
      <strong>A direct route</strong> to Alkenia, bypassing Mount Julia to shave a day off the trip. The open ocean route was <b>more dangerous</b> - worse chance of getting caught in a storm, but possibly worth it.
    </text>
  </page>"""
  apply: ->
    super()
...
Page.Library.next.push Page.LibraryNap = class LibraryNap extends Page
  ...
  text: ->"""<page bg="marketDay|marketStorm">
    <text>
      Though drawn to the library by the promise of a treasure trove of knowledge, #{@worker} couldn't help but be distracted by the beautiful weather. Really, it was hardly #{his} fault at all that a sunbeam crept across the book #{he} was reading, and who could blame #{him} for feeling a bit drowsy in the comfortable heat? No one at all. An expensive place to nap, but a peaceful one.
...
Job.Defense.next.push Page.DefenseNatalie = class DefenseNatalie extends Page
  ...
  text: ->"""<page bg="marketDay|marketStorm">
    ...
    <text>
      #{q}Hey! I heard you teach people weapons?</q> Natalie squatted down in front of the man drinking from a clay pitcher. He was rough-faced, at least two meters tall, and wore a broadsword strapped to his back. No denying that this was Torril, one of the more famous mercenaries (now retired) in Vailia.
    </text>
  </page>
  <page>
    <text continue>
...
#     #{@worker.image 'normal', 'left'}
#     <text continue>
#       #{q}Not the sword.</q> She tapped her temple, next to her grey eyes. #{q}I have heard that you may have some experience with one of my sisters. Teach me what she could do.</q></text>
#   </page>
#   <page>
#     <text continue>
...
Job.Defense.next.push Page.DefenseKat = class DefenseKat extends Page
  ...
  <page>
    #{@worker.image 'normal', 'left'}
    <text continue>
      #{q}That wasn't very nice of her,</q> Kat stuck out her tongue. #{q}Accurate though,</q> she chuckled at her sally.</text>
  </page>
